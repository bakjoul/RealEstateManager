...
class PropertyRepositoryRoom @Inject constructor(
    ...
    private fun mapPropertyEntityToDto(propertyEntity: PropertyEntity): PropertyDto =
        PropertyDto(
            ...
            administrativeAreaLevel1 = propertyEntity.address.administrativeAreaLevel1,
            administrativeAreaLevel2 = propertyEntity.address.administrativeAreaLevel2,
    ...
    private fun mapToDomainEntity(propertyWithPhotosDto: PropertyWithPhotosDto) : PropertyEntity {
        return PropertyEntity(
            ...
            address = PropertyAddressEntity(
                ...
                administrativeAreaLevel1 = propertyWithPhotosDto.propertyDto.administrativeAreaLevel1,
                administrativeAreaLevel2 = propertyWithPhotosDto.propertyDto.administrativeAreaLevel2,
    ...
    private fun mapPropertyDraftToDto(propertyId: Long, propertyForm: PropertyFormEntity): PropertyFormDto =
        PropertyFormDto(
            ...
            autoCompleteState = propertyForm.autoCompleteAddress?.administrativeAreaLevel1,
    ...
    private fun mapPropertyFormDtoToDomainEntity(propertyFormWithPhotosDto: PropertyFormWithPhotosDto) : PropertyFormEntity =
        PropertyFormEntity(
            ...
            autoCompleteAddress = PropertyFormAddress(
                ...
                administrativeAreaLevel1 = propertyFormWithPhotosDto.propertyFormDto.autoCompleteState,
            ...
            address = PropertyFormAddress(
                ...
                administrativeAreaLevel1 = propertyFormWithPhotosDto.propertyFormDto.state,
